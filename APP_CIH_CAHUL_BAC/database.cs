...
namespace APP_CIH_CAHUL_BAC
{
    public class Intrebare
    {
        ...
        public Intrebare(long id, string imgName, string r1, string r2, string r3, string c1, string c2)
        {
            this.Id = id;
    ...
    public class database1
    {
        ...
        public List<Intrebare> getData()
        {
            ...
            using (var connection = new SqliteConnection(this.connectionString))
            {
                ...
                SqliteCommand command = new SqliteCommand("SELECT ID,Intrebare,Raspuns1,Raspuns2,Raspuns3,Corect,Corect1 FROM Intrebari", connection);
                ...
                while (reader.Read())
                {
                    ...
                    data.Add(new Intrebare(id, intrebare, rs1, rs2, rs3, c1, c2));
                }
                reader.Close();
                connection.Close();
            }
